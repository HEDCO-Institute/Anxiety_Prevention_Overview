...
#copy rds file from data folder
rds_path <- here::here("data", "tables_list.rds")
file.copy(rds_path, file.path(here::here("outputs", "technical_report", "images"), basename(rds_path)))
